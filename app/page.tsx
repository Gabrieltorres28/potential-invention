...
export default function Home() {
  ...
  // Estado para controlar la visibilidad de la sección de autoridades
  const [showAuthorities, setShowAuthorities] = useState(false)

  // Asegurarse de que la sección de autoridades se muestre correctamente
  // Añadir un efecto para garantizar que el estado se actualice correctamente
  useEffect(() => {
    // Verificar si hay un hash en la URL que corresponda a "autoridades"
    if (window.location.hash === "#autoridades") {
  ...
  useEffect(() => {
    if (showAuthorities) return // No observar secciones cuando se muestra la vista de autoridades
  ...
  // Efecto para manejar el scroll cuando se muestra/oculta la sección de autoridades
  useEffect(() => {
    if (showAuthorities) {
  ...
  // Función para mostrar la sección de autoridades
  const handleShowAuthorities = () => {
    window.history.pushState({}, "", "/#autoridades")
    setShowAuthorities(true)
  }

  // Función para ocultar la sección de autoridades
  const handleCloseAuthorities = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Header onShowAuthorities={handleShowAuthorities} />

      <AnimatePresence mode="wait">
        {showAuthorities ? (
          <AuthoritiesSection key="authorities" onClose={handleCloseAuthorities} />
        ) : (
          <motion.div
            key="main-content"
            initial={{ opacity: 1 }}
                  ...
                  <motion.div className="grid gap-8 md:grid-cols-2 items-center" variants={containerVariants}>
                    <motion.div variants={itemVariants}>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Estudiar para analista de sistemas en computación te brinda una formación completa en el
                        desarrollo de software, bases de datos, redes y sistemas de información, preparándote para
                        liderar proyectos tecnológicos en empresas de cualquier tamaño.
                      </p>
                  ...
                  <motion.div className="grid gap-8 md:grid-cols-2 items-center" variants={containerVariants}>
                    ...
                    <motion.div className="order-1 md:order-2" variants={itemVariants}>
                      <h3 className="text-xl font-semibold mb-4">
                        Especialización en infraestructuras de comunicación
                      </h3>
                      <p className="text-muted-foreground mb-4">
                        La Tecnicatura en Redes te prepara para diseñar, implementar y mantener infraestructuras de
                        redes y sistemas de comunicación empresarial, con un enfoque práctico y orientado a las
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-start">
                          <span className="mr-2 text-primary">•</span>
                          <span>Certificaciones internacionales disponibles</span>
                        </li>
                      </ul>
                      <motion.div
                        whileHover={{ scale: 1.05 }}
                ...
                <div className="mx-auto max-w-4xl">
                  ...
                  <motion.div className="grid gap-8 md:grid-cols-2 items-center" variants={containerVariants}>
                    <motion.div variants={itemVariants}>
                      ...
                      <p className="text-muted-foreground mb-4">
                        La Tecnicatura en Seguridad e Higiene Laboral te brinda una formación especializada en
                        prevención de riesgos laborales, normativas de seguridad y gestión de entornos de trabajo
                        saludables.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-start">
              ...
              <div className="container relative z-10 px-4 md:px-6">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                  ...
                  >
                    ...
                    <p className="mt-4 text-lg text-muted-foreground">
                      Con más de 30 años de trayectoria, ISIPP 1206 se ha consolidado como una institución de referencia
                      en la formación de profesionales técnicos.
                    </p>
                    <div id="mision" className="mt-8 space-y-4">
                      ...
                      >
                        ...
                        <p className="mt-2 text-muted-foreground">
                          Ser reconocidos como una institución educativa de excelencia, referente en la formación
                          técnica profesional, que contribuye al desarrollo sostenible de la sociedad.
                        </p>
                      </motion.div>
                    </div>
                  </motion.div>
